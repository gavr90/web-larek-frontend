...
Интерфейс IItemCatalog 
Описывает тип данных каталога товаров и типы методов для работы с каталогом товаров
...
Класс ItemData
Хранит данные о товарах, реализует интерфейс IItemCatalogData.
Методы:
...
- setNumbers - установить порядковые номера списка товаров в корзине
...
- removeSelection - убрать состояние активной (выбранной) кнопки
